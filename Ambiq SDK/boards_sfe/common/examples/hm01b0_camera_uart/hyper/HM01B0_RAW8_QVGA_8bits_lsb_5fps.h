...
// 
// // AE
//AEG 2101~2113, use 2100 to enable
// W 24 2100 01 2 1 ; [0]: AE control enable
    {0x2100, 0x01,},
// W 24 2101 03 2 1 ; AE target mean
    {0x2101, 0x3C,},
// W 24 2102 03 2 1 ; AE min mean
    {0x2102, 0x0A},
// W 24 2103 03 2 1 ; converge in th
    {0x2103, 0x0F,},
...
// W 24 2106 78 2 1 ; max INTG Lb
    {0x2106, 0x50,},
// W 24 2107 78 2 1 ; min INTG
    {0x2107, 0x02,},
// W 24 2108 03 2 1 ; max AGain in full
    {0x2108, 0x03,},
// W 24 2109 03 2 1 ; max AGain in bin2
    {0x2109, 0x03,},
// W 24 210A 03 2 1 ; Minimum Again
    {0x210A, 0x00,},
// W 24 210B 80 2 1 ; max DGain
    {0x210B, 0x80,},
// W 24 210C 03 2 1 ; Minimum Dgain
    {0x210C, 0x40,},
// W 24 210D 03 2 1 ; Damping factor
    {0x210D, 0x00,},
// W 24 210E 03 2 1 ; Flicker Step contro
    {0x210E, 0x00,},
...
// W 24 2112 A0 2 1 ; FS 50Hz Lb
    {0x2112, 0xA0,},
// W 24 2113 66 2 1 ; Flicker Step hysteresis threshold
    {0x2113, 0x66,},
// 
// 
// // MD
